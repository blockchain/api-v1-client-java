...
import info.blockchain.api.OkClient;
 ...
 * It allows users to fetch the latest ticker data and convert amounts between BTC and fiat
 * currencies.
 */
public class ExchangeRates {
   ...
   *
   * @return A map of currencies where the key is a 3-letter currency symbol and the value is the
   * `Currency` class
  ...
  public static Map<String, Currency> getTicker(String apiCode) throws APIException, IOException {
    ...
    String response = OkClient.getOkClientInstance().get("ticker", params);
