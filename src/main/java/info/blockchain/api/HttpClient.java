...
/**
 * This is a utility class for performing API calls using GET and POST requests. It is possible to
 * override these calls by implementing HttpClientInterface. Add the new implementation via
 * setCustomHttpClient(...), such that it will get used globally.
 */
public class HttpClient implements HttpClientInterface {
  ...
  private static String openURL(String resource, Map<String, String> params, String requestMethod) throws APIException, IOException {
    ...
    if (requestMethod == null) {
      throw new APIException("Request method must be specified");
    }
